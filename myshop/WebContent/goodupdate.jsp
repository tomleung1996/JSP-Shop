	...
	<div class="container">
		<div class="row">
			...
			<div class="jumbotron" id="jumbotron">
				...
				<div class="form">
					<form class="form-horizontal" action="GoodUpdateServlet" enctype="multipart/form-data"
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" class="form-control" id="gprice" name="gprice"
									min="0" max="99999" placeholder="请输入商品价格" value="${good.gprice}"
									required>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<img id="gpic2" class="update" alt="${good.gname }" src="${good.gpic }">
							</div>
						</div>
						<div class="form-group">
